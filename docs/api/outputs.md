...
- `blendmode`: If both `blendmode_enum` and `blendmode` are given, `blendmode` will take precedence. Valid options are `0`: no blending, `1`: default/alpha blending, `2`: additive blending, `4`: modulo blending, `8`: multiply blending.
