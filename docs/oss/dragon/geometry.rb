...
S
      ...
      def line_length line
        ...
        raise e, <<-S
* ERROR:
Geometry.line_length for line x: #{line.x || "nil"}, x2: #{line.x2 || "nil"}, y: #{line.y || "nil"}, y2: #{line.y2 || "nil"}
#{e}
S
      end
...
S
      ...
      def line_angle line
        ...
        raise e, <<-S
* ERROR:
Geometry.line_angle for line x: #{line.x || "nil"}, x2: #{line.x2 || "nil"}, y: #{line.y || "nil"}, y2: #{line.y2 || "nil"}
#{e}
S
      end
