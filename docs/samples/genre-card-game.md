### Board And Card Layout - main.rb
```ruby
  # ./samples/99_genre_card_game/01_board_and_card_layout/app/main.rb
  class Game
    attr_gtk
...
### Card Animations - main.rb
```ruby
  # ./samples/99_genre_card_game/02_card_animations/app/main.rb
  class Game
    attr_gtk
