class TitleScreen
  ...
  def tick(args)
    ...
    return :start_human_vs_human if confirm_pressed?(args) && selected_option == "Human vs Human"
    return :start_human_vs_computer if confirm_pressed?(args) && selected_option == "Human vs Computer"
